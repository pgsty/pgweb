...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='modstate',
            field=models.IntegerField(choices=[(0, 'Created (submitter edits)'), (1, 'Pending moderation'), (2, 'Approved and published'), (3, '已批准，等待禁发时段结束')], default=0, verbose_name='Moderation state'),
        ),
        migrations.RunSQL(
