...
from pgweb.search.indexer import rebuild_errcodes, rebuild_extensions, rebuild_version
...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        everything = not options['versions'] and not options['extensions'] and not options['errcodes']
